...
export const Checkout = ({setCheckout}) => {
  ...
  return (
    <section>
        <div className="fixed top-0 left-0 w-full max-h-[90vh] bg-black bg-opacity-50 z-40"></div>
        <div id="authentication-modal" tabIndex="-1" className="mt-5 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:max-h-[90vh] justify-center items-center flex" aria-modal="true" role="dialog" >
            <div className="relative p-4 w-full max-w-md max-h-[90vh] md:h-auto overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
